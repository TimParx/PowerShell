...
[regex]$pattern = "^(202[0-7]|200[0-9]|[0-1][0-9]{3})(1[0-2]|0[1-9])(3[01]|[0-2][1-9]|[12]0)-([0-1]?\d|2[0-3])([0-5]?\d)?([0-5]?\d)?_(ERIN|PAPR)_([a-z0-9]{10}|[a-z0-9]{18})_(?:[1-9]|0[1-9]|10)_BT[a-z0-9]{8}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{12}0001.zip$"
...
IF ($input_file_proper.count -gt 0) {
    ...
    foreach ($file in $input_file_proper) {
        ...
        if ($file_to_move) {
            ...
            Copy-Item $file_to_move \\btsevlev02.se.ad.banctec.com\Leverans\OCFileDelivery\ManualResend\ToResend\output\
